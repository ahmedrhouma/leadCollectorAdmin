...
class Controller extends BaseController
{
    ...
    function addLog($action,$element,$element_id){
        $log = Logs::create(["action"=>$action,"element"=>$element,"access_id"=>\Session::get('accessKey_id'),"element_id"=>$element_id]);
    }
    ...
    function createErrorResponse($name){
        return response()->json([
            'code' => "Error",
            'message' => "Unexpected error, the responder has not been created."
        ],500);
    }
    /**
     * @param String $name
