...
<?php $__env->startSection('javascript'); ?>
    ...
    <script>
        ...
        var table = $('#kt_contacts_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('responders.paginate')); ?>",
            },
            columns: [
                {data: 'name', name: 'name'},
                {data: 'type', name: 'type'},
        ...
        $('#add_responder_form').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('responders.add')); ?>',
                method: 'POST',
                dataType: 'JSON',
                data: {
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\leadCollectorV2\resources\views/dashboard/responders.blade.php ENDPATH**/ ?>