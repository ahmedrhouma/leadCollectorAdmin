                           ...
                           aria-expanded="false">
                            <div class="media align-items-center">
                              <span class="avatar avatar-sm rounded-circle">
                                <img alt="Image placeholder" src="<?php echo e(Storage::disk('public')->url("uploads/".Auth::user()->account->id.".png")); ?>">
                              </span>
...
<?php /**PATH /usr/local/apache/htdocs/leadCollector/resources/views/layouts/dashboard.blade.php ENDPATH**/ ?>