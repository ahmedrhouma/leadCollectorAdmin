...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mt-3">
                    <div class="col-6">
                        <a href="<?php echo e(route('reset.password')); ?>" class="text-light"><small>Forgot password?</small></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\leadCollector\resources\views/auth/login.blade.php ENDPATH**/ ?>