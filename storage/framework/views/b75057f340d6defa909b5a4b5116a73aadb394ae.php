                ...
                <div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-overlay-y scroll-ps d-flex" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0">
                    <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-bold fs-6" data-kt-menu="true">
                        <div class="menu-item py-3">
                            <a class="menu-link <?php if(\Request::is('dashboard')): ?> active <?php endif; ?>" href="<?php echo e(route('dashboard')); ?>">
                        ...
                        <div class="menu-item py-3">
                            <a class="menu-link <?php if(\Request::is('contacts')): ?> active <?php endif; ?>" href="<?php echo e(route('contacts')); ?>">
                                <span class="menu-icon d-block text-center pt-2">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                    <span class="svg-icon svg-icon-2x">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
                            <span class="menu-link <?php if(\Request::is('settings/*')): ?> active <?php endif; ?>">
                                <span class="menu-icon d-block text-center pt-2">
                            ...
                            <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                <div class="menu-item">
                                    <a class="menu-link <?php if(\Request::is('conversations')): ?> active <?php endif; ?>" href="<?php echo e(route('conversations')); ?>">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link <?php if(\Request::is('responders')): ?> active <?php endif; ?>" href="<?php echo e(route('responders')); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link <?php if(\Request::is('forms')): ?> active <?php endif; ?>" href="<?php echo e(route('forms')); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        <div class="menu-item py-3">
                            <a class="menu-link <?php if(\Request::is('reports')): ?> active <?php endif; ?>" href="<?php echo e(route('reports')); ?>">
                                <span class="menu-icon d-block text-center pt-2">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                    <span class="svg-icon svg-icon-2x">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div data-kt-menu-trigger="click" data-kt-menu-placement="right-start" class="menu-item py-3">
                            ...
                            <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                                <div class="menu-item">
                                    <a class="menu-link <?php if(\Request::is('channels')): ?> active <?php endif; ?>" href="<?php echo e(route('channels')); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link <?php if(\Request::is('customFields')): ?> active <?php endif; ?>" href="<?php echo e(route('customFields')); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link <?php if(\Request::is('segments')): ?> active <?php endif; ?>" href="<?php echo e(route('segments')); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link <?php if(\Request::is('billing')): ?> active <?php endif; ?>" href="<?php echo e(route('billing')); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                ...
                                <div class="menu-item">
                                    <a class="menu-link <?php if(\Request::is('profile')): ?> active <?php endif; ?>" href="<?php echo e(route('profile')); ?>">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                ...
                <div class="header-container container-xxl">
                    ...
                    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
                        ...
                        <h1 class="d-flex flex-column text-dark fw-bolder my-1">
                            <span class="fs-1"><?php echo $__env->yieldContent('title'); ?></span>
                        </h1>
                        <!--end::Heading-->
                    </div>
                    <!--end::Page title=-->
...
<?php /**PATH C:\laragon\www\leadCollectorV2\resources\views/layouts/dashboard.blade.php ENDPATH**/ ?>