...
<?php $__env->startSection('javascript'); ?>
    ...
    $('[name="date"]').flatpickr({altInput:!0,altFormat:"F j, Y",dateFormat:"Y-m-d",mode:"range"});
        var table = $('#kt_contacts_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('contacts.paginate')); ?>",
            },
            columns: [
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\leadCollectorV2\resources\views/dashboard/contacts.blade.php ENDPATH**/ ?>