            ...
            <div class="header-body text-center mb-7">
                <div class="row justify-content-center">
                    <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                        ...
                        <p class="text-lead text-white">Verify your personal informations set your account password .</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <form role="form" method="POST" action="<?php echo e(route('register')); ?>">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <input class="form-control" placeholder="First name" type="text" name="first_name" value="<?php echo e($account->first_name); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <input class="form-control" placeholder="Last name" type="text" name="last_name" value="<?php echo e($account->last_name); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <input class="form-control" placeholder="Email" type="email" name="email" value="<?php echo e($account->email); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <input class="form-control" placeholder="cCompany name" type="text" name="company_name" value="<?php echo e($account->company_name); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    ...
                                    <input class="form-control" placeholder="Company URL" type="url" name="company_url" value="<?php echo e($account->company_url); ?>">
                                </div>
...
<?php /**PATH C:\laragon\www\leadCollector\resources\views/auth/register.blade.php ENDPATH**/ ?>