   ...
   'output_folder' => 'public/docs',
    ...
    'routes' => [
        [
             ...
             */
            'exclude' => [
                'medias.store', 'medias.show' ,'medias.update' , 'medias.delete','accounts.store', 'accounts.show' ,'accounts.update' , 'accounts.delete' , 'accounts.index'
                ,'profiles.store', 'profiles.show' ,'profiles.update' , 'profiles.delete' ,'authorizations.*'
            ],
