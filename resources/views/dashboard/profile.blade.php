            ...
            <div class="card card-profile">
                        ...
                        <div class="card-profile-image">
                            <form id="upload-image-form" enctype="multipart/form-data">
                                <label>
                                    @csrf
                                    <img
                                        src="{{ Storage::disk('public')->url("uploads/".Auth::user()->account->id.".png") }}"
                ...
                <div class="card-body pt-5">
                    ...
                    <div class="text-center">
                        <h5 class="h3">{{ Auth::user()->account->first_name." ".Auth::user()->account->last_name }}</span>
                        </h5>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-first-name" class="form-control"
                                               placeholder="First name" value="{{ Auth::user()->account->first_name }}" name="first_name">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-last-name" class="form-control"
                                               placeholder="Last name" value="{{ Auth::user()->account->last_name }}" name="last_name">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="input-email" class="form-control"
                                               value="{{ Auth::user()->account->email }}"  name="email">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-city" class="form-control"
                                               ...
                                               value="{{ Auth::user()->account->company_name }}"  name="company_name">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="url" id="input-country" class="form-control"
                                               ...
                                               value="{{ Auth::user()->account->company_url }}"  name="company_url">
                                    </div>
                                </div>
                            </div>
                        </div>
