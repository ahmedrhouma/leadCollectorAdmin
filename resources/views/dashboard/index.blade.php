    ...
    <div class="row mb-5 mb-xl-8 g-5 g-xl-8">
        ...
        <div class="col-3">
            ...
            <div class="card card-stretch">
                <!--begin::Link-->
                <a href="account/overview.html" class="btn btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body btn-flex flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                    ...
                    <!--end::Svg Icon-->
                    <span class="fs-4 fw-bolder">Channels</span>
                </a>
                <!--end::Link-->
            </div>
            <!--end::Card-->
        ...
        <div class="col-3">
            ...
            <div class="card card-stretch">
                ...
                <a href="#" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                    ...
                    <!--end::Svg Icon-->
                    <span class="fs-4 fw-bolder">Contacts</span>
                </a>
                <!--end::Link-->
            </div>
            <!--end::Card-->
        ...
        <div class="col-3">
            ...
            <div class="card card-stretch">
                ...
                <a href="apps/customers/view.html" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                    ...
                    <!--end::Svg Icon-->
                    <span class="fs-4 fw-bolder">Requests</span>
                </a>
                <!--end::Link-->
            </div>
            <!--end::Card-->
            ...
            <div class="card bg-default">
                <div class="card-header bg-transparent">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted fw-bold fs-7">Contacts collecte</span>
                    </h3>
                </div>
                <div class="card-body">
                    <!-- Chart -->
    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Traffic</span>
                        <span class="text-muted fw-bold fs-7">Channels</span>
                    </h3>
                </div>
                <div class="card-body">
                    <!-- Chart -->
        ...
        <div class="col-xl-4">
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Traffic</span>
                        <span class="text-muted fw-bold fs-7">Medias</span>
                    </h3>
                ...
                <div class="card-body d-flex flex-column">
                    <!--begin::Chart-->
                    <div class="mixed-widget-5-chart card-rounded-top" data-kt-chart-color="danger" style="height: 150px; min-height: 150px;">
                        <div id="apexcharts94oyk7i3" class="apexcharts-canvas apexcharts94oyk7i3 apexcharts-theme-light">
                        </div>
                    </div>
                    <!--end::Chart-->
                    <!--begin::Items-->
                    <div class="mt-5">
                            ...
                            <div class="d-flex align-items-center me-2">
                                ...
                                <div class="symbol symbol-50px me-3">
                                    <div class="symbol-label bg-light">
                                        <img src="/metronic8/demo6/assets/media/svg/brand-logos/plurk.svg" class="h-50" alt="">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Title-->
                                <div>
                                    <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder">Traffic</a>
                                    <div class="fs-7 text-muted fw-bold mt-1">Medias</div>
                                </div>
                                <!--end::Title-->
                            </div>
                            <!--end::Section-->
                        ...
                        <div class="d-flex flex-stack mb-5">
                            ...
                            <div class="d-flex align-items-center me-2">
                                ...
                                <div class="symbol symbol-50px me-3">
                                    <div class="symbol-label bg-light">
                                        <img src="/metronic8/demo6/assets/media/svg/brand-logos/figma-1.svg" class="h-50" alt="">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Title-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-2">
                                ...
                                <div class="symbol symbol-50px me-3">
                                    <div class="symbol-label bg-light">
                                        <img src="/metronic8/demo6/assets/media/svg/brand-logos/vimeo.svg" class="h-50" alt="">
                                    </div>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Title-->
...
@section('javascript')
    <script>
        var contacts = @json($contacts_stat_month);
        var channel_traffic = @json($data_traffic_channels);
    </script>
