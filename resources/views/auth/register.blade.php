                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      <div class="input-group input-group-merge input-group-alternative mb-3">
                          ...
                          <input class="form-control" placeholder="cCompany name" type="text" name="company_name" value="{{ old('company_name') }}">
                      </div>
                      @error('company_name')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
                  ...
                  <div class="form-group">
                      <div class="input-group input-group-merge input-group-alternative mb-3">
                          ...
                          <input class="form-control" placeholder="Company URL" type="url" name="company_url" value="{{ old('company_url') }}">
                      </div>
                      @error('company_url')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
